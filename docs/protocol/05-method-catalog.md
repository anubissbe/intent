...
The API exposes **419 dispatchable method names** across the following categories:
...
| pr | 7 | comment, create, merge, refresh, review, status, updateBranch — repository-scoped writes added in v10.5 (§5.7) |
