...
| §5.47 Multiplayer — `principal.*` / `workspace.invite.*` / `invite.redeem` / `workspace.members.*` (principals, invite links, membership, the collaborator allowlists) | [methods/multiplayer.md](./methods/multiplayer.md) |
